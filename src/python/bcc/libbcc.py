...
lib.bpf_prog_attach.argtypes = [ct.c_int, ct.c_int, ct.c_int, ct.c_uint]
lib.bpf_prog_detach.restype = ct.c_int
lib.bpf_prog_detach.argtypes = [ct.c_int, ct.c_int]
lib.bpf_prog_detach2.restype = ct.c_int
lib.bpf_prog_detach2.argtypes = [ct.c_int, ct.c_int, ct.c_int]
